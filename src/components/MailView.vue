...
export default {
  ...
  setup(props, {emit}) {
    ...
    let goNewerAndArchive = () => { emit('changeEmail', { changeIndex: 1, toggleArchive: true, save: true, closeModal: true }) }
    let goOlderAndArchive = () => { emit('changeEmail', { changeIndex: 1, toggleArchive: true, save: true, closeModal: true }) }
